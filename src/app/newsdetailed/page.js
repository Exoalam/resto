...
const NewsDetailPage = async () => {
    ...
    const shortDescription = await searchParams.get('shortDescription');
    const longDescription = await searchParams.get('longDescription');
    const image = await searchParams.get('image');
