      ...
      <div className='grid grid-cols-3 gap-y-10 w-[70%] m-auto pt-10 pb-10'>
        ...
        <div className="card w-96 bg-base-100 shadow-md hover:shadow-2xl hover:scale-[101%]">
          ...
          <div className="card-body">
            ...
            <p>VD Company selected as Advanced Restaurant Industry Automation Solution Company
            by the Korean Food Promotion Agencys Overseas Korean Restaurant Council Workshop.</p>
          </div>
        </div>
        <div className="card w-96 bg-base-100 shadow-md hover:shadow-2xl hover:scale-[101%]">
          ...
          <div className="card-body">
            ...
            <p>VD Company holds the largest-ever promotion Robot Festival
            to celebrate reaching 10,000 VD members.</p>
          </div>
        </div>
        <div className="card w-96 bg-base-100 shadow-md hover:shadow-2xl hover:scale-[101%]">
          ...
          <div className="card-body">
            ...
            <p>Announcement of share certificate submission 
            due to stock split.</p>
          </div>
        </div>
        <div className="card w-96 bg-base-100 shadow-md hover:shadow-2xl hover:scale-[101%]">
          ...
          <div className="card-body">
            ...
            <p>VD Company ranked first among Best Medium-sized and Small Businesses to Work for 
        ...
        <div className="card w-96 bg-base-100 shadow-md hover:shadow-2xl hover:scale-[101%]">
          ...
          <div className="card-body">
            ...
            <p>MBNs restaurant start-up survival program Birth of a CEO - Open War, an emerging entertainment powerhouse... Fierce mission war for 100 million won in start-up support.</p>
          </div>
        </div>
      </div>
    </div>
