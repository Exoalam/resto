      ...
      <div className='grid grid-cols-3 gap-y-10 w-[70%] m-auto pt-10 pb-10'>
        ...
        <div className="card w-96 bg-base-100 shadow-md hover:shadow-2xl hover:scale-[101%]">
          ...
          <div className="card-body">
            ...
            by the Korean Food Promotion Agency's Overseas Korean Restaurant Council Workshop.</p>
          </div>
        </div>
        <div className="card w-96 bg-base-100 shadow-md hover:shadow-2xl hover:scale-[101%]">
        ...
        <div className="card w-96 bg-base-100 shadow-md hover:shadow-2xl hover:scale-[101%]">
          ...
          <div className="card-body">
            ...
            <p>MBN's restaurant start-up survival program 'Birth of a CEO - Open War', 
                                an emerging entertainment powerhouse... Fierce mission war for 
                                100 million won in start-up support.</p>
          </div>
        </div>
      </div>
    </div>
